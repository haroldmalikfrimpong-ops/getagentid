      ...
      <section className="py-24 px-6 md:px-20">
        ...
        >
          ...
          <p className="text-gray-400 text-center text-lg mb-16 max-w-2xl mx-auto">
            AI agents are like the internet before SSL — anyone can pretend to be anyone.
            AgentID fixes that.
          </p>
            ...
            {[
              {
                ...
                desc: 'Cryptographic proof that "this agent belongs to Barclays and does customer service." Signed, verifiable, revocable.',
              },
              {
                icon: '🔍',
                title: 'Agent Registry',
                desc: 'Searchable directory to find agents by capability. "Find me an agent that handles insurance claims."',
              },
              {
                icon: '✓',
                title: 'Verification API',
                desc: 'One API call to verify if an agent is legit before trusting it. Real-time. Instant.',
              },
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-24 px-6 md:px-20 bg-[#080812]">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-black text-center mb-16">
            <span className="holo-gradient">3 Lines of Code</span>
          </h2>
      ...
      <section className="py-24 px-6 md:px-20">
        ...
        >
          <h2 className="text-3xl font-black text-center mb-12">
            <span className="holo-gradient">History Repeats</span>
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
            {['The Internet Had', 'AI Agents Need', 'We Build'].map((header, col) => (
              <div key={col}>
                <div className="text-xs font-mono text-cyan-500/60 uppercase tracking-wider text-center py-3 border-b border-cyan-500/10">
                  {header}
                </div>
                {[
                  ['SSL Certificates', 'Agent Certificates', 'AgentID Certs'],
                  ['DNS', 'Agent Discovery', 'AgentID Registry'],
                  ['WHOIS', 'Agent Ownership', 'AgentID Profiles'],
                  ['Certificate Authority', 'Agent Authority', 'AgentID'],
                ].map((row, i) => (
                  <div key={i} className="text-sm text-gray-400 text-center py-3 border-b border-white/5">
                    {row[col]}
                  </div>
                ))}
              </div>
      ...
      <section className="py-24 px-6 md:px-20 bg-[#080812]">
        ...
        >
          <h2 className="text-3xl font-black mb-8">
            <span className="holo-gradient">The Opportunity</span>
          </h2>
          ...
          <p className="text-gray-400 text-lg">
            Nobody has shipped a working, cross-organization agent identity system.
            <span className="text-white font-bold"> We ship first, we define the standard.</span>
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-32 px-6 text-center">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-black mb-4">
            <span className="holo-gradient">Start Building Trust</span>
          </h2>
          <p className="text-gray-500 mb-10 max-w-lg mx-auto">
            Register your first agent in seconds. Free tier — 5 agents, 1,000 verifications/month.
          </p>
